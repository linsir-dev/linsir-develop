 ...
 * 演示基于Selector的多路复用IO
 */
public class MultiplexedIODemo {
    ...
    public static void startServer() {
        System.out.println("3. 多路复用IO模式示例:");
        System.out.println("启动多路复用IO服务器，端口: " + PORT);
        System.out.println("特点: 基于Selector，利用操作系统多路复用机制");
        ...
        try {
            ...
            System.out.println("多路复用IO服务器已启动，等待连接...");
    ...
    private static boolean handleRead(SelectionKey key) throws IOException {
        ...
        if (len > 0) {
            ...
            // 发送响应
            String response = "Multiplexed IO Server Response: " + clientMessage;
     ...
     * 客户端测试
     */
    private static void clientTest(int clientId) {
        try (SocketChannel socketChannel = SocketChannel.open()) {
            socketChannel.connect(new InetSocketAddress("localhost", PORT));
            
            // 发送消息
            String message = "Hello Multiplexed IO Server! Client " + clientId;
            ...
            if (len > 0) {
                ...
                System.out.println("客户端 " + clientId + " 接收到响应: " + response);
            }
